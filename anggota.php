...
<table class="table table-striped table-hover">
    ...
    <?php
        //Query Join 3 tabel////////////////////////////////////////////////////////////////////
        $uerybaru = mysqli_query(konek,"SELECT anggota.nis, anggota.nama, anggota.jk, anggota.nomor_telepon, anggota.alamat, kelas.nama_kelas, jurusan.nama_jurusan
        FROM anggota
        JOIN kelas ON anggota.id_kelas = kelas.id_kelas
        JOIN jurusan ON anggota.id_jurusam = jurusan.id_jurusan")
